...
public:
    ...
    static int get_count() { return UnitCounter<ScoutUnit, details::maxScoutCount>::get_count(); }
    static int get_max_count() { return UnitCounter<ScoutUnit, details::maxScoutCount>::get_max_count(); }
};