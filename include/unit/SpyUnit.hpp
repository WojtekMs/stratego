...
public:
    ...
    static int get_count() { return UnitCounter<SpyUnit, details::maxSpyCount>::get_count(); }
    static int get_max_count() { return UnitCounter<SpyUnit, details::maxSpyCount>::get_max_count(); }
};
