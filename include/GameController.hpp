...
public:
  ...
  bool get_end_game_info_box_button_pressed() {
    return end_game_info_box_button_pressed;
  };
  ...
  std::string get_victorious_player_name() const {
    return victorious_player_name;
  };
